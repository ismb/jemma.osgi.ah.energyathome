...
public class PowerAndControlClusterProxySimpleTest extends PowerAndControlClusterProxy implements PowerProfileClient {
	...
	protected PowerProfileServer getRemotePowerProfileCluster(String applianceId) {
		return new PowerProfileServer() {
			...
			private PowerProfileTransferredPhase[] powerProfileTransferredPhases = new PowerProfileTransferredPhase[] { powerProfileTransferredPhase1,
					powerProfileTransferredPhase2 };
			...
			public PowerProfileScheduleConstraintsResponse execPowerProfileScheduleConstraintsRequest(short PowerProfileID, IEndPointRequestContext context)
