...
public class SixTierDailyTariff extends DailyTariff {
	public SixTierDailyTariff() throws Exception {
		...
		TariffIntervals[] workdays = new TariffIntervals[] { new TariffIntervals(0.0001f, new int[] { 000, 200, 2300, 2400 }),
				new TariffIntervals(0.0014f, new int[] { 200, 800 }), new TariffIntervals(0.050f, new int[] { 800, 1100 }), new TariffIntervals(1.80f, new int[] { 1100, 1500 }),
				new TariffIntervals(5.24f, new int[] { 1800, 2300 }), new TariffIntervals(120.28f, new int[] { 1500, 1800 }) };
